...
<div class="right-column">
        ...
        <input type="date" id="first_date" name="first_date" value="<?php echo $fdate; ?>" required><br>
        ...
        <input type="date" id="third_date" name="third_date" value="<?php echo isset($tdate) ? $tdate : ''; ?>" required><br>

        <label for="first_show">First Show</label>
        <input type="time" name="first_show" id="first_show" value="<?php echo $fshow; ?>" required><br>

        <label for="second_show">Second Show:</label>
        <input type="time" name="second_show" id="second_show" value="<?php echo isset($sshow) ? $sshow : ''; ?>" required><br>

        <label for="third_show">Third Show:</label>
        <input type="time" name="third_show" id="third_show" value="<?php echo isset($tshow) ? $tshow : ''; ?>" required><br>
